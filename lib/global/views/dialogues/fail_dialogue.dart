...
class FailDialoge extends StatefulWidget {
  final String text;
  final String buttontext;
  final VoidCallback func;
  final Column col;
  final Container head;
  const FailDialoge(this.text, this.buttontext, this.func, this.col, this.head);

  @override
  State<FailDialoge> createState() => _FailDialogeState();
}

class _FailDialogeState extends State<FailDialoge> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  // CustomTextWidget(widget.text, redcolor, 16),
                  CustomSizeBox(40),
                  widget.col,
                  CustomSizeBox(30),
                  if (widget.buttontext != 'Withdraw')
                    Padding(
