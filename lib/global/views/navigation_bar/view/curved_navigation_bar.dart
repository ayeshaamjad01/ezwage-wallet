import 'package:ezwage/global/views/navigation_bar/view/nav_button.dart';
import 'package:ezwage/global/views/navigation_bar/view/nav_custom_painter.dart';
...
class CurvedNavigationBarState extends State<CurvedNavigationBar>
  ...
  late int _length;
  int currentIndex = 0;
  var bottomTabLogosList = [
    'assets/images/video.svg',
    'assets/images/ez_services_icon.png',
    'assets/images/home_color.svg',
                  ...
                  child: Center(
                    child: Transform.translate(
                      ...
                      child: Material(
                        ...
                        shape: CircleBorder(
                            // side: BorderSide(color: Color(0xffF5F5F5), width: 3.5)
                            ),
                        child: Padding(
                          padding: const EdgeInsets.all(20.0),
                          child: bottomTabLogosList[currentIndex]
                                  .contains('.svg')
                              ? SvgPicture.asset(
                                  bottomTabLogosList[currentIndex],
                                  color:
