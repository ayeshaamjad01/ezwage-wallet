...
/// @nodoc
mixin _$CustomerDetailResponseDto {
...
@override
String toString() {
  return 'CustomerDetailResponseDto(customerId: $customerId, accountTitle: $accountTitle, email: $email, mobileNo: $mobileNo, cnic: $cnic, currentAddress: $currentAddress, permanentAddress: $permanentAddress, iban: $iban, accountBalance: $accountBalance, accountStatus: $accountStatus, accountType: $accountType, gender: $gender, extInfo: $extInfo)';
}
...
/// @nodoc
abstract mixin class $CustomerDetailResponseDtoCopyWith<$Res>  {
  factory $CustomerDetailResponseDtoCopyWith(CustomerDetailResponseDto value, $Res Function(CustomerDetailResponseDto) _then) = _$CustomerDetailResponseDtoCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$CustomerDetailResponseDtoCopyWithImpl<$Res>
    implements $CustomerDetailResponseDtoCopyWith<$Res> {
  _$CustomerDetailResponseDtoCopyWithImpl(this._self, this._then);

  final CustomerDetailResponseDto _self;
  final $Res Function(CustomerDetailResponseDto) _then;
...
/// Adds pattern-matching-related methods to [CustomerDetailResponseDto].
extension CustomerDetailResponseDtoPatterns on CustomerDetailResponseDto {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CustomerDetailResponseDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CustomerDetailResponseDto() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CustomerDetailResponseDto value)  $default,){
final _that = this;
switch (_that) {
case _CustomerDetailResponseDto():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CustomerDetailResponseDto value)?  $default,){
final _that = this;
switch (_that) {
case _CustomerDetailResponseDto() when $default != null:
return $default(_that);case _:
...
class _CustomerDetailResponseDto implements CustomerDetailResponseDto {
  const _CustomerDetailResponseDto({this.customerId, this.accountTitle, this.email, this.mobileNo, this.cnic, this.currentAddress, this.permanentAddress, this.iban, this.accountBalance, this.accountStatus, this.accountType, this.gender, final  Map<String, dynamic>? extInfo}): _extInfo = extInfo;
  factory _CustomerDetailResponseDto.fromJson(Map<String, dynamic> json) => _$CustomerDetailResponseDtoFromJson(json);
...
@pragma('vm:prefer-inline')
_$CustomerDetailResponseDtoCopyWith<_CustomerDetailResponseDto> get copyWith => __$CustomerDetailResponseDtoCopyWithImpl<_CustomerDetailResponseDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$CustomerDetailResponseDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CustomerDetailResponseDto&&(identical(other.customerId, customerId) || other.customerId == customerId)&&(identical(other.accountTitle, accountTitle) || other.accountTitle == accountTitle)&&(identical(other.email, email) || other.email == email)&&(identical(other.mobileNo, mobileNo) || other.mobileNo == mobileNo)&&(identical(other.cnic, cnic) || other.cnic == cnic)&&(identical(other.currentAddress, currentAddress) || other.currentAddress == currentAddress)&&(identical(other.permanentAddress, permanentAddress) || other.permanentAddress == permanentAddress)&&(identical(other.iban, iban) || other.iban == iban)&&(identical(other.accountBalance, accountBalance) || other.accountBalance == accountBalance)&&(identical(other.accountStatus, accountStatus) || other.accountStatus == accountStatus)&&(identical(other.accountType, accountType) || other.accountType == accountType)&&(identical(other.gender, gender) || other.gender == gender)&&const DeepCollectionEquality().equals(other._extInfo, _extInfo));
}
...
/// @nodoc
abstract mixin class _$CustomerDetailResponseDtoCopyWith<$Res> implements $CustomerDetailResponseDtoCopyWith<$Res> {
  factory _$CustomerDetailResponseDtoCopyWith(_CustomerDetailResponseDto value, $Res Function(_CustomerDetailResponseDto) _then) = __$CustomerDetailResponseDtoCopyWithImpl;
@override @useResult
$Res call({
 int? customerId, String? accountTitle, String? email, String? mobileNo, String? cnic, String? currentAddress, String? permanentAddress, String? iban, String? accountBalance, String? accountStatus, String? accountType, String? gender, Map<String, dynamic>? extInfo
});
...
/// @nodoc
class __$CustomerDetailResponseDtoCopyWithImpl<$Res>
    implements _$CustomerDetailResponseDtoCopyWith<$Res> {
  __$CustomerDetailResponseDtoCopyWithImpl(this._self, this._then);

  final _CustomerDetailResponseDto _self;
  final $Res Function(_CustomerDetailResponseDto) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? customerId = freezed,Object? accountTitle = freezed,Object? email = freezed,Object? mobileNo = freezed,Object? cnic = freezed,Object? currentAddress = freezed,Object? permanentAddress = freezed,Object? iban = freezed,Object? accountBalance = freezed,Object? accountStatus = freezed,Object? accountType = freezed,Object? gender = freezed,Object? extInfo = freezed,}) {
  return _then(_CustomerDetailResponseDto(
customerId: freezed == customerId ? _self.customerId : customerId // ignore: cast_nullable_to_non_nullable
as int?,accountTitle: freezed == accountTitle ? _self.accountTitle : accountTitle // ignore: cast_nullable_to_non_nullable
as String?,email: freezed == email ? _self.email : email // ignore: cast_nullable_to_non_nullable
as String?,mobileNo: freezed == mobileNo ? _self.mobileNo : mobileNo // ignore: cast_nullable_to_non_nullable
