...
class SetAmountWalletSheet extends StatelessWidget {
  final AmountSheetType sheetType;
  SetAmountWalletSheet({super.key, required this.sheetType});
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            14.verticalSpace,
          //   (walletTransferPro.selectedContact != null) ? ListTile(
          //   leading: ClipOval(
          //     child: Container(
          ...
          //   title: Text(walletTransferPro.selectedContact?.displayName ?? ""),
          //   subtitle: Text(walletTransferPro.selectedContact?.phones.firstOrNull?.number ?? ""),
          ...
          // ) :
              ...
              children: [
                Expanded(
                  child: TextFieldWithTitle(
                    ...
                    controller: walletTransferPro.phoneController,
                    onValidate: (value) {
                ...
                InkWell(
                  onTap: () async {
                    walletTransferPro.updateSearch("");
                    ...
                    Contact? selectedContact = await Navigator.of(context).push(
                      ...
                      if (selectedContact != null) {
                        ...
                        walletTransferPro.selectContact(selectedContact); // Or do whatever you need
                      }
                  },
            ...
            CustomButtonWidget(
              ...
              onPressed: () {
                walletTransferPro.walletToWalletInquiry(context, amountController.text);
                // Navigator.push(context, MaterialPageRoute(builder: (context) => TransferStatusPage(),),);
