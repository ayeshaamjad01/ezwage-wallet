...
class SelectInternetProviderPage extends StatelessWidget {
  const SelectInternetProviderPage({super.key});
                  ...
                  children: [
                    Row(
                      children: [
                        Expanded(
                          child: TextField(
                            onChanged: (value) => transferPro.updateInternetFilter(value),
