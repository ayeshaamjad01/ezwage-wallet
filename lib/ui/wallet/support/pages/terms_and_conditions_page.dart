            ...
            child: Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    CustomText(
                      text: "Terms & Conditions For Ez Wallet",
                    ...
                    CustomText(
                      text:
                          "Welcome to Ezwallet. Please read these Terms and Conditions (\"Terms\") carefully before using our mobile application (\"the App\") operated by Ezwage.By downloading, installing, or using the App, you agree to be bound by these Terms. If you do not agree, please do not use the App.",
                      size: 14.sp,
                      maxLines: 10,
                    ),
                    5.verticalSpace,
